...
export function TableComponent({ data }: { data: any }) {
	...
	return (
		<div className="max-w-[100%] bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
			{/* <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 flex"> */}
			<div className="px-4 sm:px-6 lg:px-8 py-8">
				<Card className="bg-white/70 backdrop-blur-sm border-0 shadow-lg max-w-[100%]">
					<CardHeader>
						<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4"></div>
					</CardHeader>
					<CardContent>
						<div className="rounded-md border overflow-x-auto max-w-[100%]">
							<Table>
