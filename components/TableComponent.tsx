...
export function TableComponent({ data }: { data: any }) {
	...
	return (
		<div className="flex max-w-6xl sm:max-w-xl md:max-w-xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-full bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
